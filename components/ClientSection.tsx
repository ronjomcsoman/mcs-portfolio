...
const clients = [
    ...
    { name: 'Areej Vegetable Oils', category: 'Manufacturing', logo: '/clients/areej.png' },
    ...
    { name: 'Royal Oman Police', category: 'Government', logo: '/clients/rop.png' },
    ...
    { name: 'Emdad Logistics', category: 'Logistics', logo: '/clients/emdad.png' },
